...
loginAPI.post('/post', function(req, res) {
	if (req.body.firstName == '' || req.body.lastName == '') {
		...
		// set cookie (firstName)
		res.cookie('firstName', req.body.firstName, { path: '/cookie', signed: true, maxAge: 10 * 60 * 1000 });
		// set cookie (lastName)
		res.cookie('lastName', req.body.lastName, { path: '/cookie', signed: true, maxAge: 10 * 60 * 1000 });
